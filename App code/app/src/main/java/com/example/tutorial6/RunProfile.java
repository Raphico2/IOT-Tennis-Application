...
public class RunProfile extends AppCompatActivity{

    String[] variableNames = {"speed", "endurance"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        listeFloats.add(new BarEntry(0, Float.parseFloat(result[1])));
        listeFloats.add(new BarEntry(1, Float.parseFloat(result[3])));


        String sentence = result[4];
